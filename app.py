...
# Load all 5 models from the 'Models' folder
def load_models():
    model1 = pickle.load(open(os.path.join("Models", "countVectorizer.pkl"), "rb"))
    model2 = pickle.load(open(os.path.join("Models", "model_dt.pkl"), "rb"))
    model3 = pickle.load(open(os.path.join("Models", "model_rf.pkl"), "rb"))
    model4 = pickle.load(open(os.path.join("Models", "model_xgb.pkl"), "rb"))
    model5 = pickle.load(open(os.path.join("Models", "scaler.pkl"), "rb"))
